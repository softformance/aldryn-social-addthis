...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Links.instagram'
        db.add_column(u'aldryn_social_addthis_links', 'instagram',
                      self.gf('django.db.models.fields.URLField')(max_length=200, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Links.instagram'
        db.delete_column(u'aldryn_social_addthis_links', 'instagram')
