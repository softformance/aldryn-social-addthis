...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Like'
        db.create_table(u'aldryn_social_addthis_like', (
        ...
        db.send_create_signal(u'aldryn_social_addthis', ['Like'])

        # Adding model 'Mail'
        db.create_table(u'aldryn_social_addthis_mail', (
            (u'cmsplugin_ptr', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['cms.CMSPlugin'], unique=True, primary_key=True)),
        ...
        db.send_create_signal(u'aldryn_social_addthis', ['Mail'])

        # Adding model 'Links'
        db.create_table(u'aldryn_social_addthis_links', (
            (u'cmsplugin_ptr', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['cms.CMSPlugin'], unique=True, primary_key=True)),
            ('facebook', self.gf('django.db.models.fields.URLField')(max_length=200, null=True, blank=True)),
            ('google', self.gf('django.db.models.fields.URLField')(max_length=200, null=True, blank=True)),
        ...
        db.send_create_signal(u'aldryn_social_addthis', ['Links'])


    def backwards(self, orm):
        # Deleting model 'Like'
        db.delete_table(u'aldryn_social_addthis_like')

        # Deleting model 'Mail'
        db.delete_table(u'aldryn_social_addthis_mail')

        # Deleting model 'Links'
        db.delete_table(u'aldryn_social_addthis_links')


    models = {
        u'aldryn_social_addthis.like': {
            'Meta': {'object_name': 'Like', '_ormbases': ['cms.CMSPlugin']},
        ...
        u'aldryn_social_addthis.links': {
            'Meta': {'object_name': 'Links', '_ormbases': ['cms.CMSPlugin']},
            u'cmsplugin_ptr': ('django.db.models.fields.related.OneToOneField', [], {'to': "orm['cms.CMSPlugin']", 'unique': 'True', 'primary_key': 'True'}),
        ...
        u'aldryn_social_addthis.mail': {
            'Meta': {'object_name': 'Mail', '_ormbases': ['cms.CMSPlugin']},
