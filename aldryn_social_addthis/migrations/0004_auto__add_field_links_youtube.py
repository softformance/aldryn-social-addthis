...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Links.youtube'
        db.add_column(u'aldryn_social_addthis_links', 'youtube',
                      self.gf('django.db.models.fields.URLField')(max_length=200, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Links.youtube'
        db.delete_column(u'aldryn_social_addthis_links', 'youtube')
