...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Links.google'
        db.add_column(u'aldryn_social_addthis_links', 'google',
                      self.gf('django.db.models.fields.URLField')(max_length=200, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Links.google'
        db.delete_column(u'aldryn_social_addthis_links', 'google')
